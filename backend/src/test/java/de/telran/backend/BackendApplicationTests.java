...
class BackendApplicationTests {
    ...
    @Test
    void listAllVideo() {
        List<Video> all = videoRepository.findByNameContaining("Amazon");
    ...
    @Test
    void listAllVideo2() {
        List<Video> all2 = videoRepository.findByNameContaining("Day");
        assertEquals(true, !all2.isEmpty());
        assertEquals(5, all2.size());
    }
    @Test
    void listAllVideo3(){
        List<Video> all3 = videoRepository.findByNameContaining("IT");
